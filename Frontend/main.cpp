 ...
 */
 ...
 /*
 argv[1] = current acount file path & filename
 argv[2] = output transaction file path & filename
 argv[3] = input transaction session file path & filename
 */
int main(int argc, char* argv[]) {
    ...
    string input;
    string file = "";
    transactionFile = "./input transaction files-daily/session1-tf.txt";
    accountFile = "./input transaction files-daily/initial_current_accounts.txt";
